...
This project applies Bayesian state-space modeling to predict laptop battery degradation and forecast future hardware failure. Using weekly charge-capacity data from a Lenovo laptop sensor, the model isolates the battery's true physical decay from highly erratic measurement noise.
